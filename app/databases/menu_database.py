...
def clean_coffee_name(name: str) -> str:
    ...
    # Remove weight patterns like 250г, 500, 1000g, etc.
    name = re.sub(r'\d+\s*(?:г|гр|g|грам|грамм)?', '', name, flags=re.IGNORECASE).strip()
    # Remove trailing/leading dashes or punctuation
